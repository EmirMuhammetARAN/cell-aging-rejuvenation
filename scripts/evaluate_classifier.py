...
RESULTS_PATH_NAME = 'generated_epoch_50'
TEST_YOUNG_PATH = os.path.join(parent_dir, 'data/processed/test/young')
TEST_OLD_PATH = os.path.join(parent_dir, 'data/processed/test/senescent')
RESULTS_PATH = os.path.join(parent_dir, f'results/{RESULTS_PATH_NAME}')  
CORRECT_OF_YOUNG = 0
CORRECT_OF_OLD = 0
...
model.load_state_dict(torch.load(os.path.join(parent_dir, 'checkpoints/classifier.pth')))
model.to('cuda')
model.eval()
